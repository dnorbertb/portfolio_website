export const pArr = [
    ...
    },
    {
        ...
        content: "I am an IT technician by education, currently working as Front-end developer for Riotters based in Szczecin, Poland. My adventure with IT began when I was 12 and since then I have learned a lot about different fields of IT. I serviced various electronic devices, like PC’s or mobile phones, configured networks, used various operating systems on VPS servers and PC computers. I have experience with Linux (Debian and Debian based, Manjaro, Arch), macOS and Windows.  I configured game servers, VPN servers, databases, hosted Node.js applications, using applications such as nginx and pm2. I did a lot of different things related to computer science that are simply too many to describe them all. I even coded controllers or worked with computer diagnostics of vehicles."
    },
    {
        title: "In the future",
        content: "What I want to learn will mainly depend on what I need at work, but I have already thought about it and I think I want to learn C# and Go. I also like creating mobile applications, I am currently working on one application in React Native but as I am an iPhone user, Swift need to definitely appear in my stack. I also plan to learn about Azure and other cloud related tools."
    },
    // {
    //     title: "Comment",
