export const pArr = [
    ...
    },
    {
        ...
        content: "The projects shown on this page and this page were made just for demonstration purposes. Apart from them I did many other small projects that learned me a lot. I learned from my mistakes, solved the problems I got, improved performance and responsiveness. I have created many things(I have two github profiles), like for example E2EE Chat using OpenPGP.js and WebSockets, fullstack blog applications or my own CMS.  These projects are not here because I am not completely satisfied with them and the CMS still needs a lot of fixes and changes to improve SEO."
    },
    {
        title: "About me technically",
        content: "I am an IT technician by education, currently working as generally speaking IT-Support. My adventure with IT began when I was 12 and since then I have learned a lot about different fields of IT. I serviced various electronic devices, like PC’s or mobile phones, configured networks, used various operating systems on VPS servers and PC computers. I have experience with Linux (Debian and Debian based, Manjaro, Arch), macOS and Windows.  I configured game servers, VPN servers, databases, hosted Node.js applications, using applications such as nginx and pm2. I did a lot of different things related to computer science that are simply too many to describe them all. I even coded controllers or worked with computer diagnostics of vehicles."
    },
    {
        title: "In the future",
